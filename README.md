...
I'm an IT graduate from San Beda University based in Metro Manila, Philippines. I'm building my career in data analytics — cleaning messy datasets, finding patterns, and turning numbers into clear visual stories.

---

## 🛠️ What I Work With

**Analytics & Visualization:** Power BI, Excel (pivot tables, EDA), Jupyter Notebook  
**Programming:** Python (pandas, numpy, matplotlib, seaborn), basic SQL  
**Web Development:** HTML, CSS, Bootstrap, CodeIgniter  
**Tools:** Google Colab, Git/GitHub, MySQL, Microsoft Office Suite  
...
- [IBM Professional Data Analyst](https://coursera.org/share/380de4ed260fca922b51aa6b2b9c3f8e) — Coursera / IBM (April 2026)
- [The Complete Full-Stack Web Development Bootcamp](https://www.udemy.com/certificate/UC-1ea26687-8046-4e7c-b483-f34d6d80a88e/) — Udemy (April 2025)

---

## Contacts

- linkedin: [@NoelBallena](https://www.linkedin.com/in/noel-antonio-ballena-834654351/)
